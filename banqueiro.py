import os
from banqueiro_utils import *


def main():
    qtd_processos = int(input('\nDigite quantos processos estão em execução:\n' \
                               '>>> '))
    qtd_tipos_recursos = int(input('\nDigite quantos tipos de recursos necessitará cada processo:\n' \
                               '>>> '))
